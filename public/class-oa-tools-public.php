...
class OA_Tools_Public
{
    ...
    public function customizer_settings($wp_customize)
    {
        ...
        $wp_customize->add_control('oaldr_categorize_positions', array(
            ...
            'type' => 'select',
            'choices' => array(
                'oaldr_chapter' => __('Chapter', 'OA Leadership Position Plugin'),
                'oaldr_lodge' => __('Lodge', 'OA Leadership Position Plugin'),
                'oaldr_section' => __('Section', 'OA Leadership Position Plugin'),
            ),
        ));
    }
